...
**当前源码版本：0.9.0-rc.2 · 项目格式：1 / 2 · 接口协议：1**
...
> **0.9.0-rc.2 为待用户手动验收的开发版本。** 本版接通 Quest、通用模块、地图覆盖层、有声排演和素材往返；全部预设共享相同能力。工程检查与真实设备／模型验收分开记录。详见 [任务状态](docs/tasks/STATUS_0.9.0.md) 与 [本轮验证](docs/protocol/QA_0.9.0_RC2.md)。
...
创作模块、Quest和排演有独立工作区，文档中可显示问题层。新增六类预设（空白、游戏、叙事、剧本、微电影、综合）、可追加框架与虚构样例。综合样例提供60份文档、74个对象、18份媒体和78秒排演；示意图、合成演示音和预置问答不是真实用户决定。
